...
public class ByteUtils {
     ...
     */
    public static String[] strToBinaryBytes(String src, Charset charset, boolean isForMat) {
        charset = charset == null ? Charset.forName("utf-8") : charset;
        byte[] bytes = src.getBytes(charset);// 字符串转数组
        ...
        return isForMat ? hexSStrs : binaryStrs;
    }
